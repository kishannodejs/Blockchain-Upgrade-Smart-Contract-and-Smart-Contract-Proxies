...
export default function Logic2({ backdrop, setBackdrop, tx, setTx, receipt, setReceipt }) {
    ...
    useEffect(() => {
        if (state.accounts) {
            setTimeout(async () => {
                await state.Logic2Contract.methods._contractAddress().call({ from: state.accounts[0] })
                    .then(e => {
                        //console.log(e);
                        setContractAdd(e);
                    })
    ...
    const getDataHandler = async () => {
        await state.Logic2Contract.methods.myAddress().call({ from: state.accounts[0] })
            .then(e => {
                //console.log(e);
                setMyAdd(e);
            })
            .catch(err => console.log(err));
        await state.Logic2Contract.methods.myUint().call({ from: state.accounts[0] })
            .then(e => {
                //console.log(e);
                setMyUint(e);
            })
            .catch(err => console.log(err));
        await state.Logic2Contract.methods.balanceOf(state.accounts[0]).call({ from: state.accounts[0] })
            .then(e => {
                //console.log(e);
    ...
    const setDataHandler = async () => {
        ...
        setBackdrop(true);
        await state.Logic2Contract.methods.setAddress(_myAdd).send({ from: state.accounts[0] })
            .then(e => {
                //console.log(e);
                setReceipt(e)
                setTx(true);
    ...
    const incUintHandler = async () => {
        ...
        setBackdrop(true);
        await state.Logic2Contract.methods.inc().send({ from: state.accounts[0] })
            .then(e => {
                //console.log(e);
                setReceipt(e)
                setTx(true);
    ...
    const decUintHandler = async () => {
        ...
        setBackdrop(true);
        await state.Logic2Contract.methods.dec().send({ from: state.accounts[0] })
            .then(e => {
                //console.log(e);
                setReceipt(e)
                setTx(true);
    ...
    const depositETHHandler = async () => {
        ...
        setBackdrop(true);
        await state.Logic2Contract.methods.deposit()
            .send({
    ...
    const withdrawETHHandler = async () => {
        ...
        setBackdrop(true);
        await state.Logic2Contract.methods.withdraw(Web3.utils.toWei(_myBalance, 'ether'))
            .send({
                from: state.accounts[0]
            })
            .then(e => {
